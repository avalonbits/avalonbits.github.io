...
Elm.IncludeHappeningModal = Elm.IncludeHappeningModal || {};
Elm.IncludeHappeningModal.make = function (_elm) {
   "use strict";
   _elm.IncludeHappeningModal = _elm.IncludeHappeningModal || {};
   if (_elm.IncludeHappeningModal.values) return _elm.IncludeHappeningModal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (x,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("whatHappened"),$Html$Attributes.$class("modal modal-fixed-footer")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("modal-content")]),
              _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text(model.modalTitle)]))
                      ,A2($Html.form,
                      ...
                      _U.list([$Html$Attributes.placeholder("What happened?"),$Html$Attributes.id("what_happened")]),
                      _U.list([]))]))]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("modal-footer")]),
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href("#!"),$Html$Attributes.$class("modal-action modal-close waves-effect waves-red btn-flat")]),
                      _U.list([$Html.text("Cancel")]))
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("#!"),$Html$Attributes.$class("modal-action modal-close waves-effect waves-red btn-flat")]),
                      _U.list([$Html.text("OK")]))]))]));
   });
   var init = {modalTitle: "It happened",title: "",description: ""};
   var Model = F3(function (a,b,c) {    return {modalTitle: a,title: b,description: c};});
   return _elm.IncludeHappeningModal.values = {_op: _op,Model: Model,init: init,view: view};
};
Elm.FixedButton = Elm.FixedButton || {};
Elm.FixedButton.make = function (_elm) {
   "use strict";
   _elm.FixedButton = _elm.FixedButton || {};
   if (_elm.FixedButton.values) return _elm.FixedButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $IncludeHappeningModal = Elm.IncludeHappeningModal.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var btnPosition = _U.list([{ctor: "_Tuple2",_0: "bottom",_1: "45px"},{ctor: "_Tuple2",_0: "right",_1: "24px"}]);
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("fixed-action-btn"),$Html$Attributes.style(btnPosition)]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.$class("modal-trigger waves-effect waves-light btn-floating btn-large red"),$Html$Attributes.href("#whatHappened")]),
              _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("large material-icons")]),_U.list([$Html.text(model.label)]))]))]))
              ,A2($IncludeHappeningModal.view,address,model.modal)]));
   });
   var init = function (label) {    return {label: label,modal: $IncludeHappeningModal.init};};
   var Model = F2(function (a,b) {    return {label: a,modal: b};});
   return _elm.FixedButton.values = {_op: _op,init: init,view: view,Model: Model};
};
Elm.Native.Time = {};
...
Elm.Happening = Elm.Happening || {};
Elm.Happening.make = function (_elm) {
   "use strict";
   _elm.Happening = _elm.Happening || {};
   if (_elm.Happening.values) return _elm.Happening.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("col s12 m12 l6")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("card blue-grey darken-1")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("card-content white-text")]),
              _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("card-title")]),_U.list([$Html.text(model.title)]))
                      ,A2($Html.p,_U.list([]),_U.list([$Html.text(model.description)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("card-action")]),
              _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text("Delete")]))
                      ,A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text("Again")]))]))]))]));
   });
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "NoOp") {
            ...
            return _U.update(model,{title: _p0._0,description: _p0._1});
         }
   });
   var Modify = F2(function (a,b) {    return {ctor: "Modify",_0: a,_1: b};});
   var NoOp = {ctor: "NoOp"};
   var init = F2(function (title,description) {    return {title: title,description: description,count: 0,last_time: 1400000000};});
   var Model = F4(function (a,b,c,d) {    return {title: a,description: b,count: c,last_time: d};});
   return _elm.Happening.values = {_op: _op,init: init,view: view,update: update,Model: Model};
};
Elm.Nav = Elm.Nav || {};
Elm.Nav.make = function (_elm) {
   "use strict";
   _elm.Nav = _elm.Nav || {};
   if (_elm.Nav.values) return _elm.Nav.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#"),$Html$Attributes.$class("brand-logo center")]),_U.list([$Html.text(model)]))]))]));
   });
   var update = F2(function (x,model) {    return model;});
   var Nothing = {ctor: "Nothing"};
   var init = "It Happened";
   return _elm.Nav.values = {_op: _op,init: init,view: view,update: update};
};
Elm.HappeningList = Elm.HappeningList || {};
Elm.HappeningList.make = function (_elm) {
   "use strict";
   _elm.HappeningList = _elm.HappeningList || {};
   if (_elm.HappeningList.values) return _elm.HappeningList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $FixedButton = Elm.FixedButton.make(_elm),
   $Happening = Elm.Happening.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Insert") {
            var newHappening = {ctor: "_Tuple2",_0: model.nextID,_1: A2($Happening.init,"The title","A pretty big description for such a small event")};
            var newHappenings = A2($List._op["::"],newHappening,model.happenings);
            return _U.update(model,{happenings: newHappenings,nextID: model.nextID + 1});
         } else {
            var updateHappening = function (_p1) {
               var _p2 = _p1;
               var _p4 = _p2._1;
               var _p3 = _p2._0;
               return _U.eq(_p0._0,_p3) ? {ctor: "_Tuple2",_0: _p3,_1: A2($Happening.update,_p0._1,_p4)} : {ctor: "_Tuple2",_0: _p3,_1: _p4};
            };
            return _U.update(model,{happenings: A2($List.map,updateHappening,model.happenings)});
         }
   });
   var Modify = F2(function (a,b) {    return {ctor: "Modify",_0: a,_1: b};});
   var viewHappening = F2(function (address,_p5) {    var _p6 = _p5;return A2($Happening.view,A2($Signal.forwardTo,address,Modify(_p6._0)),_p6._1);});
   var Insert = {ctor: "Insert"};
   var view = F2(function (address,model) {
      var addBtn = A2($FixedButton.view,A2($Signal.forwardTo,address,$Basics.always(Insert)),model.addBtn);
      var items = A2($List.map,viewHappening(address),model.happenings);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("container")]),_U.list([A2($Html.div,_U.list([$Html$Attributes.$class("row")]),items)])),addBtn]));
   });
   var init = {happenings: _U.list([]),nextID: 0,addBtn: $FixedButton.init("+")};
   var Model = F3(function (a,b,c) {    return {happenings: a,nextID: b,addBtn: c};});
   return _elm.HappeningList.values = {_op: _op,Model: Model,init: init,Insert: Insert,Modify: Modify,update: update,view: view,viewHappening: viewHappening};
};
Elm.App = Elm.App || {};
Elm.App.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $HappeningList = Elm.HappeningList.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Items = function (a) {    return {ctor: "Items",_0: a};};
   var NavElement = function (a) {    return {ctor: "NavElement",_0: a};};
   var view = F2(function (address,model) {
      var items = A2($HappeningList.view,A2($Signal.forwardTo,address,Items),model.items);
      var nav = A2($Nav.view,A2($Signal.forwardTo,address,NavElement),model.nav);
      return A2($Html.div,_U.list([]),_U.list([nav,items]));
   });
   var Nothing = {ctor: "Nothing"};
   var init = {nav: $Nav.init,items: $HappeningList.init};
   var update = F2(function (act,model) {
      var _p0 = act;
      switch (_p0.ctor)
      {case "Nothing": return init;
         case "NavElement": return _U.update(model,{nav: A2($Nav.update,_p0._0,model.nav)});
         default: return _U.update(model,{items: A2($HappeningList.update,_p0._0,model.items)});}
   });
   var Model = F2(function (a,b) {    return {nav: a,items: b};});
   return _elm.App.values = {_op: _op,init: init,view: view,update: update,Model: Model};
};
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: $App.init,update: $App.update,view: $App.view});
